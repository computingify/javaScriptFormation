...
document.addEventListener(
  ...
  async function () {
    ...
    const section1 = createSection('section1');

    let tweetsShowed = createAllTweets(tweets);
    document.body.append(tweetsShowed);

    const button = filterButton(tweets, isFr, tweetsShowed);
