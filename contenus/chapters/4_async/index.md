...
![](C:\Users\compu\AppData\Roaming\marktext\images\2020-11-25-14-35-33-image.png)
...
![](C:\Users\compu\AppData\Roaming\marktext\images\2020-11-25-14-37-00-image.png)

Au bout de 5sec nous avons bien le log Valeur Promise
...
// Mieux et c'est équivalent à ce qui est au dessus
maPromesse
  .then(function (vp1) {
    console.log('VP1', vp1);
...
<mark>Si jamais la création de `p2` dépend de `vp1`, alors il n'y a pas de réel problème.</mark>
...
<mark>Si on veut synchroniser plusieurs promesses,</mark> on peut utiliser
...
![](C:\Users\compu\AppData\Roaming\marktext\images\2020-11-25-16-20-21-image.png)

Pour concaténer 2 tableaux (.flat()):

![](C:\Users\compu\AppData\Roaming\marktext\images\2020-11-25-16-21-28-image.png)

**<u>~~Attention ça rejette si une seul reject, tout les promesses sont rejet</u>é.~~**

Sinon on peut utiliser .allSettled à la place de .all
